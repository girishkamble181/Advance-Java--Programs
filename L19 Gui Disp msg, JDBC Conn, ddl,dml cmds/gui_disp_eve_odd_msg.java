// GUI to display even or odd msg

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

class A8 extends JFrame
{
	Container c;
	JLabel lbl_number;
	...
	A8()
	{
		...
		ActionListener a1 = (ae) -> 
		{
			try
			{
				...
				String msg = "ur number is " + num + " and result is " + res;
				JOptionPane.showMessageDialog(c, msg, "Result", JOptionPane.INFORMATION_MESSAGE); 
			}
			catch(NumberFormatException e)
			{
				String msg = "u shuld enter integers only";
				JOptionPane.showMessageDialog(c, msg, "Galat kiya", JOptionPane.ERROR_MESSAGE);
				txt_number.setText("");
